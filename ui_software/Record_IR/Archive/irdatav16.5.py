...
from PyQt4.QtGui import (QImage, QWidget, QApplication, QLabel, QPixmap, QPushButton, QVBoxLayout, QGridLayout, QSizePolicy, QMessageBox, QFileDialog, QTextCursor)
import sys
import os.path
import cv2
...
class App(QtGui.QMainWindow, Ui_MainWindow):
	...
	try:
		def thread_second():
	    		call(["python", "irDataViewerv10.py"])
