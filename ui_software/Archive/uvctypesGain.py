...
class stateStruct(Structure):
  _fields_ = [("state", c_ubyte)]
...
def print_gain_state(devh):
  print(devh)
  vers = stateStruct()
  print(stateStruct.state)
  stateBuf = create_string_buffer(4)
  sysGainId = 0x0200 + 0x0048
  #print(sysGainId)
  print('call extensions about to be called')
  #for x in range (1,255):
	#print(x)
  call_extension_unit(devh, SYS_UNIT_ID, 0x48, stateBuf, 4)
  print("State: {0}".format(repr(stateBuf.raw)))
  print('passed call extensions')

def set_gain_state(devh):
  stateBuf = create_string_buffer(4)
  sysGainId = 0x0200 + 0x0048
  #print(sysGainId)
  print('call extensions about to be called')
  #for x in range (1,255):
	#print(x)
  set_extension_unit(devh, SYS_UNIT_ID, 0x49, 'LEP_SYS_GAIN_MODE_LOW', 4)
  print("State: {0}".format(stateBuf.raw))
  print('passed call extensions')