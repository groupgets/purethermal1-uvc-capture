...
file_nameH = 'Lepton HDPY Vid Thu Jul 26 17:44:39 2018'

f_read = h5py.File(file_nameH, 'r')
print(len(f_read))
for i in range (1, len(f_read)):
	#print(i)	
	#print(np.shape(f_read[('image'+str(i))]))
	data = f_read[('image'+str(i))][:]
	...
	cv2.imshow('Lepton Radiometry', rgbImage)
	cv2.waitKey(1)
	time.sleep(0.111)
