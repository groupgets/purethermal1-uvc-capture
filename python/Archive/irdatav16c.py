...
qtCreatorFile = "ir_v6.ui"  # Enter file here.
...
def startRec():
	...
	file_nameH = str(('Lepton HD5F Vid ' + QDateTime.currentDateTime().toString()))
	try:
...
class App(QtGui.QMainWindow, Ui_MainWindow):
	...
	try:
		def thread_second():
	    		call(["python", "postScriptIRv7.py"])
		processThread = threading.Thread(target=thread_second)  # <- note extra ','
		processThread.start()
	except:
		print('Post Processing Script Error')
